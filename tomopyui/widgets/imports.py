...
class Import_Nexus(ImportBase):
    """"""

    def __init__(self):
        super().__init__()
        self.raw_uploader = RawUploader_Nexus(self)
        self.make_tab()
...
class RawUploader_Nexus(UploaderBase):
    """
    """
    ...
    def __init__(self, Import):
        ...
        self._init_widgets()
        self.projections = RawProjections_Nexus()
        self.reset_metadata_to = Metadata_Nexus_Raw
        self.Import = Import
        self.filechooser.title = "Import Raw NeXus File"
        self.filetypes_to_look_for = [".nx"]
        self.files_not_found_str = "Choose a directory with a .nxs file."
